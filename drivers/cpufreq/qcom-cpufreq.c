...
static DEFINE_PER_CPU(struct cpufreq_suspend_t, suspend_data);
      ...
      #ifdef CONFIG_MACH_MSM8996_LUCYE
	      static unsigned int upper_limit_freq[NR_CPUS] = {2188800, 2188800, 2342400, 2342400};
		  #define CPU_MAX_OC_FREQ_BC 2342400 // OC NOT SET YET
		  #define CPU_MAX_OC_FREQ_LC 2188800 // OC NOT SET YET
	  #else
...
void set_cpu_min_lock(unsigned int cpu, int freq)
{
	if (cpu >= 0 && cpu < NR_CPUS) {
		/*
		 * msm8996/msm8996Pro device has 2 cpu clusters,
