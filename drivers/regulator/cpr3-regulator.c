...
int cpr3_regulator_get_ceiling_voltage(struct regulator *regulator,
		int cori)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
...
int cpr3_regulator_get_floor_voltage(struct regulator *regulator,
		int cori)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
...
int cpr3_regulator_get_last_voltage(struct regulator *regulator,
		int cori)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
...
int cpr3_regulator_set_ceiling_voltage(struct regulator *regulator,
		int cori, int volt)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
...
int cpr3_regulator_set_floor_voltage(struct regulator *regulator,
		int cori, int volt)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
...
int cpr3_regulator_set_last_voltage(struct regulator *regulator,
		int cori, int volt)
{
	struct cpr3_regulator *cpr_vreg = regulator_get_drvdata(regulator);
	cori--;
