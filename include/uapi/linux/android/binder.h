...
enum flat_binder_object_flags {
	...
	/**
	 * @FLAT_BINDER_FLAG_THREAD: this node has a dedicated thread
	 */
 ...
 *              the node.
 *
 * The binder driver has support for linking a node to a thread, which ensures
 * that all (a)synchronous transactions into that node are handled on this
 * thread. If userspace wants this behavior, it has to pass this object
